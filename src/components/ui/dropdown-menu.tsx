...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn('focus-ring flex cursor-default select-none items-center rounded-md px-2 py-2 text-sm outline-none data-[state=open]:bg-secondary', inset && 'pl-8', className)}
    {...props}
  >
    {children}
